...
def scrape_glassdoor_jobs():
    """Scrapes job postings from Glassdoor and extracts locations dynamically."""
    ...
    for job_title in JOB_TITLES:
        ...
        for job in jobs:
            try:
                ...
                date_posted = job.find_element(By.CLASS_NAME, "job-age").text
    ...
    print(f"✅ Scraped {len(all_jobs)} jobs from Glassdoor")
